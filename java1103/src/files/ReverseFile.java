 ...
 * result.dat in reverse order. The input file should contain exactly one real
 * number per line.
 */
...
public class ReverseFile {
	public static void main(String[] args) {
		...
		try { // Create the input stream.
			data = new TextReader(new FileReader(System.getProperty("user.dir") + "/file/data.dat"));
